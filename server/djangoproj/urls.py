...
urlpatterns = [#solo redirecciona al url del html y ya en el html se redirecciona al url del backend
    ...
    path('dealers/', TemplateView.as_view(template_name="index.html")),#se anexó esta url
    path('dealer/<int:dealer_id>',TemplateView.as_view(template_name="index.html")),#se anexó esta url
